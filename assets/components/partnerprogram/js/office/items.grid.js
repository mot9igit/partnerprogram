partnerProgram.grid.Items = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        baseParams: {
            action: 'partnerprogram/processor',
            method: 'item/getlist',
        },
        multi_select: true,
        viewConfig: {
...
Ext.extend(partnerProgram.grid.Items, OfficeExt.grid.Default, {
    windows: {},
    ...
    getColumns: function (config) {
        return [{
            ...
            header: _('partnerprogram_grid_actions'),
            dataIndex: 'actions',
    ...
    getTopBar: function (config) {
        return [{
            text: '<i class="fa fa-plus"></i>&nbsp;' + _('partnerprogram_item_create'),
