partnerProgram.grid.Default = function (config) {
    config = config || {};
    ...
    Ext.applyIf(config, {
        ...
        baseParams: {},
        cls: config['cls'] || 'main-wrapper partnerprogram-grid',
        autoHeight: true,
        paging: true,
        remoteSort: true,
        ...
        viewConfig: {
            ...
            getRowClass: function (rec) {
                ...
                if (rec.data['active'] != undefined && rec.data['active'] == 0) {
                    cls.push('partnerprogram-row-inactive');
                }
                if (rec.data['required'] != undefined && rec.data['required'] == 1) {
                    cls.push('partnerprogram-row-required');
                }
                return cls.join(' ');
            }
        },
    });
    partnerProgram.grid.Default.superclass.constructor.call(this, config);
...
Ext.extend(partnerProgram.grid.Default, MODx.grid.Grid, {
...
Ext.reg('partnerprogram-grid-default', partnerProgram.grid.Default);