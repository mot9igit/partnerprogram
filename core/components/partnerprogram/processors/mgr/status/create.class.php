...
class ppObjectsStatusCreateProcessor extends modObjectCreateProcessor
{
    /** @var ppStatus $object */
    public $object;
    ...
    public function beforeSet()
    {
        ...
        if ($this->modx->getCount($this->classKey, array('name' => $this->getProperty('name')))) {
            $this->modx->error->addField('name', $this->modx->lexicon('partnerprogram_err_ae'));
        }
...
return 'ppObjectsStatusCreateProcessor';