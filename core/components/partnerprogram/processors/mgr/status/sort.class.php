...
class ppObjectsStatusSortProcessor extends modObjectProcessor
{
    ...
    public function process()
    {
        ...
        foreach ($sources as $id) {
            /** @var ppObjectsStatus $source */
            $source = $this->modx->getObject($this->classKey, compact('id'));
            /** @var ppObjectsStatus $target */
    ...
    /**
     * @param ppObjectsStatus $source
     * @param ppObjectsStatus $target
     *
     * @return array|string
     */
    public function sort(ppObjectsStatus $source, ppObjectsStatus $target)
    {
...
return 'ppObjectsStatusSortProcessor';
