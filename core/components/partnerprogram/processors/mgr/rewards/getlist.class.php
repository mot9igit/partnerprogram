...
class ppRewardsGetListProcessor extends modObjectGetListProcessor
{
	...
	public function prepareQueryBeforeCount(xPDOQuery $c)
	{
		...
		$this->query = $c;
		$c->select(
			$this->modx->getSelectColumns('ppRewards', 'ppRewards', '', array(), true) . ',
...
return 'ppRewardsGetListProcessor';
